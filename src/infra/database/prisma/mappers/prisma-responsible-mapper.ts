import {
  ResponsibleParties as PrismaResponsible,
  Prisma,
...
type PrismaResponsibleProps = PrismaResponsible & {
...
export class PrismaResponsibleMapper {
  ...
  static toDomainWithCustomer(raw: PrismaResponsibleProps): ResponsibleParties {
    return ResponsibleParties.create(
      {
        firstName: raw.firstName,
        lastName: raw.lastName,
